...
VOLUME_GROWTH_THRESHOLD = 2  # Ngưỡng tốc độ phát triển của khối lượng so với EMA21
PRICE_THRESHOLD = 1 # Phần trăm

# Telegram Bot Configuration
TELEGRAM_TOKEN = "6462681730:AAE4_9qV7m04EOB3NfGGFXyksuuWKnftUk0"  # Thay YOUR_TELEGRAM_BOT_TOKEN bằng TOKEN của bot Telegram
...
def main():
    ...
    if breakout_results:
        ...
        message = "📢 *Danh sách  Breakout 15M bứt phá* 📊\n"
